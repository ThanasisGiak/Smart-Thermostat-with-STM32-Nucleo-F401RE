...
// Joystick control. 
#define P_TMP PA_0            // connect data pin of temp sensor              
#define P_PROX_ECHO PA_1      // connect echo pin of prox sensor
#define P_PROX_TRIGGER PA_4   // connect trigger pin of prox sensor
//#define P_SW_CR PA_4
#define P_SW_DN PB_0
#define P_SW_LT PC_1
#define P_SW_RT PC_0
